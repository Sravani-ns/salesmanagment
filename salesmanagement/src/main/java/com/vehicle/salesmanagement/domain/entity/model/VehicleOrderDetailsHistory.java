...
public class VehicleOrderDetailsHistory {
    ...
    public VehicleOrderDetails getVehicleOrderDetails() {
        return vehicleOrderDetails;
    }

    public void setVehicleOrderDetails(VehicleOrderDetails vehicleOrderDetails) {
        this.vehicleOrderDetails = vehicleOrderDetails;
    }
